...
<body>
	...
	<header>
		...
		<?php 
			...
			{
				echo '<a href="landing.php?form_conn=oui" >
						<div class="connexion">CONNEXION</div>
					</a>';
			}
			else
			{
				echo '<a href="landing.php?form_deconn=oui" >
...
<!-- 					<li>
					...
					<li>
						<a href="#universe"><img src="assets/images/Ball.png" alt="boule de cristal"><p>L'UNIVERS</p></a>
					</li>
					<li>
						<a href="#game"><img src="assets/images/Glass.png" alt="verre"><p>LE JEU</p></a>
					</li>
					<li>
						<a href="#team"><img src="assets/images/Salt.png" alt="salière"><p>L'EQUIPE</p></a>
					</li>
	            </ul>
			</nav>

			<p class="propagande">
				Réserve ta soirée pour le 28 novembre !
			</p>
	...
	<main>
		...
		<section id="team">
			...
			<div class="team_container">
				...
				<div class="logo_team6" id="aurelie"><p class="name_team6">aurelie<br><span>designer</span></p></div>

				<div class="logo_team6" id="cecile"><p class="name_team6">cecile<br><span>designer</span></p></div>

				<div class="logo_team6" id="clement"><p class="name_team6">clement<br><span>designer</span></p></div>
			...
			<div class="team_container">
				...
				<div class="logo_team6" id="timothee"><p class="name_team6">timothee<br><span>developpeur</span></p></div>
